      ...
      <div className="p-4 border-b border-secondary-200 dark:border-secondary-700">
        <div className="space-y-3">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => setCurrentScreen('profile')}>
            <UserAvatar user={currentUser} size="md" showStatus={true} />
          ...
          {/* Manager-only navigation dropdown */}
          {currentUser.role === 'manager' && (
            <div className="space-y-1">
              <button
                onClick={() => setAdminMenuOpen(!adminMenuOpen)}
                className="w-full flex items-center justify-between p-2 rounded-lg transition-colors hover:bg-secondary-100 dark:hover:bg-secondary-800 text-secondary-600 dark:text-secondary-400 text-sm"
              >
                <div className="flex items-center gap-2">
              ...
              {adminMenuOpen && (
                <div className="ml-4 space-y-1 border-l-2 border-secondary-200 dark:border-secondary-700 pl-4">
                  <button
